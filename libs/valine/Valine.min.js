...
!function(e, t) {
            ...
            for (var p = 1, d = !0; p < n.length; p += 1) {
                ...
                y(h, s))
                    ...
                    if (u && p + 1 >= n.length) {
                        var x = u(l, v);
                        d = !!x,
                        l = d && "get"in x && !("originalValue"in x.get) ? x.get : l[v]
                    } else
                        d = y(l, v),
                        l = l[v];
                    d && !c && (h[s] = l)
        ...
        a.default)(s.default, {
            ...
            dynamicLoadSource: function(e, t) {
                ...
                s.default)('script[src="' + e + '"]').length)
                    ...
                    (0,
                    s.default)("head")[0].appendChild(n),
                    n.src = e
                }
            },
            sdkLoader: function(e, t, n) {
                t in window && window[t] ? (k && clearTimeout(k),
                n && n()) : s.default.dynamicLoadSource(e, function() {
    ...
    , function(e, t, n) {
        ...
        e.exports = function(e, t) {
            ...
            if (!a(t))
                throw new i("Assertion failed: IsPropertyKey(P) is not true, got " + o(t));
            return e[t]
        }
    }
    , function(e, t, n) {
...
*/
            ...
            function n(e) {
                ...
                if (e && e.nodeName && "TEXTAREA" === e.nodeName && !o.has(e)) {
                    ...
                    function() {
                        ...
                        "vertical" === t.resize ? e.style.resize = "vertical"/*<==注意：这里于2022.12.6修改，将none 改为 horizontal。修复textarea点击后拉伸按钮消失问题！*/
    ...
    , function(e, t, n) {
        ...
        i.prototype.init = function(e) {
            ...
            var t = this;
            return e && (e = A.default.extend(h.CONFIG, e),
            t.i18n = (0,
            f.default)(e.lang || A.default.lang, e.langMode),
            t.cfg = e,
        ...
        i.prototype._init = function() {
            ...
            try {
                ...
                $.hide = "hide" === n,
                $.cdn = /^https?\:\/\//.test(i) ? i : $.cdn,
                e.cfg.pageSize = isNaN(s) ? 10 : s < 1 ? 10 : s,
                l && (0,
                ...
                if (p = p instanceof HTMLElement ? p : d[d.length - 1] || null) {
                    ...
                    $.hide && e.$el.addClass("hide-avatar"),
                ...
                y.default)(e.cfg, function(t) {
                    var n = (0,
                    A.default)(".valine-comment-count")
                      , r = 0;
                    !function t(n) {
                        var i = n[r++];
                        if (i) {
                            var o = (0,
                            A.default)(i).attr("data-xid");
        ...
        var j = function(e, t) {
            ...
            n.save().then(function(e) {
                (0,
                A.default)(t.el).find(".leancloud-visitors-count").text(1)
            }).catch(function(e) {})
        }
          , T = {
            add: function(e, t) {
                var n = this
                  , r = (0,
                A.default)(".leancloud_visitors,.leancloud-visitors");
                if (1 === r.length) {
                    var i = r[0]
                      , o = decodeURI((0,
                    A.default)(i).attr("id"))
                      , a = (0,
                    A.default)(i).attr("data-flag-title")
                      , u = encodeURI(o)
                      , s = {
                        el: i,
                        url: o,
                    ...
                    if (decodeURI(o) === decodeURI(t)) {
                        ...
                        l.find().then(function(t) {
                            if (t.length > 0) {
                                ...
                                n.save().then(function(e) {
                                    (0,
                                    A.default)(i).find(".leancloud-visitors-count").text(e.get("time"))
                                }).catch(function(e) {})
                            } else
                                j(e, s)
                        }).catch(function(t) {
            ...
            show: function(e, t) {
                ...
                if (t.forEach(function(e) {
                    var t = (0,
                    A.default)(e).find(".leancloud-visitors-count");
                    t && t.text("0"),
                    n.push(/\%/.test((0,
                    A.default)(e).attr("id")) ? decodeURI((0,
                    A.default)(e).attr("id")) : (0,
                    A.default)(e).attr("id"))
                }),
                n.length) {
        ...
        i.prototype.bind = function() {
            ...
            var f = function(t) {
                ...
                r || e.$preview.hide(),
                O != r && (O = r,
                i.hasClass("actived") > -1 && O != n.html() && n.html((0,
                E.default)(O)),
                R())
            };
                    ...
                    n.on("input change blur propertychange", function(r) {
                        ...
                        b.fetchQQFn)(n.val(), function(e) {
                            var t = e.nick || n.val()
                              , r = e.qq + "@qq.com";
                            (0,
                            A.default)(".vnick").val(t),
                            (0,
                            A.default)(".vmail").val(r),
                            S.nick = t,
                            S.mail = r,
                            S.QQAvatar = e.pic
                        })),
                    ...
                    i && i.length) {
                        ...
                        e.Q(e.cfg.path, o).then(function(e) {
                            (e && e.results || []).forEach(function(e) {
                                T(e, (0,
                                A.default)('.vquote[data-self-id="' + e.get("rid") + '"]'))
                            })
                        }).catch(function(e) {}),
                        t * n < r ? F.show() : F.hide(),
                        R()
            ...
            var j = function() {
              ...
              , T = function(t, n, r) {
                var i = (0,
                A.default)('<div class="vcard" id="' + t.id + '"></div>')
                  , o = (0,
                C.default)(t.get("ua"))
                  , a = "";
                o && !/ja/.test(e.cfg.lang) && (o = A.default.detect(o),
                ...
                var s = t.get("link") ? /^https?\:\/\//.test(t.get("link")) ? t.get("link") : "http://" + t.get("link") : ""
                  , l = A.default.escape((0,
                C.default)(t.get("nick").substring(0, 20)))
                  , c = s ? '<a class="vnick" rel="nofollow" href="' + j(s) + '" target="_blank" >' + l + "</a>" : '<span class="vnick">' + l + "</span>"
                  , f = $.hide ? "" : e.cfg.enableQQ && t.get("QQAvatar") ? (0,
                C.default)('<img class="vimg" src="' + j(t.get("QQAvatar")) + '" referrerPolicy="no-referrer"/>') : '<img class="vimg" src="' + ($.cdn + (0,
                u.default)(t.get("mail")) + $.params) + '">'
                  , p = f + '<div class="vh"><div class="vhead">' + c + " " + a + '</div><div class="vmeta"><span class="vtime" >' + (0,
              ...
              , z = function(t, n) {
                t.on("click", function(r) {
                    ...
                    (0,
                    A.default)('.vreply-wrapper[data-self-id="' + o + '"]').append(a).find(".cancel-reply").show(),
                    I = {
            ...
            var M = e.$el.find(".vsubmit")
              , L = function(t) {
                if (e.cfg.requiredFields.indexOf("nick") > -1 && S.nick.length < 3)
                    return v.nick[0].focus(),
                    void e.$el.find(".status-bar").text("" + e.i18n.t("nickFail")).empty(3e3);
                if (e.cfg.requiredFields.indexOf("mail") > -1 && !/[\w-\.]+@([\w-]+\.)+[a-z]{2,3}/.test(S.mail))
              ...
              , U = function() {
                ...
                var t = AV.Object.extend(e.cfg.clazzName || "Comment")
                  , n = new t;
                if (S.url = decodeURI(e.cfg.path),
                S.insertedAt = new Date,
                I.rid) {
                    var r = I.pid || I.rid;
                    n.set("rid", I.rid),
                    n.set("pid", r),
                    S.comment = O.replace("<p>", '<p><a class="at" href="#' + r + '">' + I.at + "</a> , ")
                }
                for (var i in S)
                ...
                n.save().then(function(t) {
                    ...
                    try {
                        I.rid ? T(t, (0,
                        A.default)('.vquote[data-self-id="' + I.rid + '"]'), !0) : (Number(n.text()) ? n.text(Number(n.text()) + 1) : e.$el.find(".vcount").show().find(".vnum").text(Number(n.text()) + 1),
            ...
            M.on("click", L),
            (0,
            A.default)(document).on("keydown", function(e) {
            ...
            o.on("dragenter dragleave dragover drop", function(e) {
                e.stopPropagation(),
                e.preventDefault(),
                "drop" === e.type && Q(e.dataTransfer.items)
            });
            var Q = function(e, t) {
        ...
        var r = n(3)
          ...
          , a = function(e, t) {
            ...
            n && n.qq == e ? t && t(n) : i.default.ajax({
                ...
                e.json().then(function(e) {
                    e.errmsg || (i.default.store.set(o.QQCacheKey, e),
                    t && t(e))
                })
            })
        }
        ...
        !function(i) {
            ...
            function p(e, t) {
                ...
                for (n = 0; n < e.length; n += 16)
                    ...
                    a = h,
                    u = v,
                    p = s(p, d, h, v, e[n], 7, -680876936),
                    v = s(v, p, d, h, e[n + 1], 12, -389564586),
                    h = s(h, v, p, d, e[n + 2], 17, 606105819),
                    d = s(d, h, v, p, e[n + 3], 22, -1044525330),
                    p = s(p, d, h, v, e[n + 4], 7, -176418897),
                    v = s(v, p, d, h, e[n + 5], 12, 1200080426),
                    h = s(h, v, p, d, e[n + 6], 17, -1473231341),
                    d = s(d, h, v, p, e[n + 7], 22, -45705983),
                    p = s(p, d, h, v, e[n + 8], 7, 1770035416),
                    v = s(v, p, d, h, e[n + 9], 12, -1958414417),
                    h = s(h, v, p, d, e[n + 10], 17, -42063),
                    d = s(d, h, v, p, e[n + 11], 22, -1990404162),
                    p = s(p, d, h, v, e[n + 12], 7, 1804603682),
                    v = s(v, p, d, h, e[n + 13], 12, -40341101),
                    h = s(h, v, p, d, e[n + 14], 17, -1502002290),
                    d = s(d, h, v, p, e[n + 15], 22, 1236535329),
        ...
        t.default = function(e) {
            ...
            new Promise(function(t, n) {
                ...
                for (var d in e.headers)
                    s.setRequestHeader(d, e.headers[d]);
    ...
    , function(e, t, n) {
        ...
        e.exports = function(e) {
            ...
            return "default" === t && (a(e) || u(e)) && (t = "string"),
            s(e, "default" === t ? "number" : t)
        }
    }
    , function(e, t, n) {
        "use strict";
    ...
    , function(e, t, n) {
        ...
        e.exports = function(e) {
            ...
            }, u = Math.max(0, t.length - o.length), s = [], l = 0; l < u; l++)
                s.push("$" + l);
    ...
    , function(e, t, n) {
        !function(e, n) {
            ...
            function A(e, t, n) {
                ...
                try {
                    var u = U.lex(e, t);
                    return t.walkTokens && A.walkTokens(u, t.walkTokens),
                    V.parse(u, t)
                } catch (e) {
              ...
              , M = function() {
                ...
                n.heading = function(e) {
                    ...
                    if (t) {
                        ...
                        return this.lexer.inline(i.text, i.tokens),
                        i
                    }
                }
                ,
                ...
                n.list = function(e) {
                    ...
                    if (t) {
                        ...
                        t = y.exec(e)) && !this.rules.block.hr.test(e); ) {
                            ...
                            c = t[2].split("\n", 1)[0],
                            f = e.split("\n", 1)[0],
                            this.options.pedantic ? (a = 2,
                            d = c.trimLeft()) : (a = t[2].search(/[^ ]/),
                            a = a > 4 ? 1 : a,
                            d = c.slice(a),
                            a += t[1].length),
                            s = !1,
                        ...
                        for (u = 0; u < D; u++) {
                            ...
                            m.items[u].tokens = this.lexer.blockTokens(m.items[u].text, []);
                ...
                n.html = function(e) {
                    ...
                    if (t) {
                        ...
                        return this.options.sanitize && (n.type = "paragraph",
                        n.text = this.options.sanitizer ? this.options.sanitizer(t[0]) : s(t[0]),
                        n.tokens = [],
                ...
                n.table = function(e) {
                    ...
                    if (t) {
                        ...
                        if (n.header.length === n.align.length) {
                            ...
                            for (u = n.rows.length,
                            r = 0; r < u; r++)
                                n.rows[r] = h(n.rows[r], n.header.length).map(function(e) {
                                    return {
                                        text: e
                                    }
                                });
                ...
                n.lheading = function(e) {
                    ...
                    if (t) {
                        ...
                        return this.lexer.inline(n.text, n.tokens),
                        n
                    }
                }
                ,
            ...
            L.bullet = /(?:[*+-]|\d{1,9}[.)])/,
            L.listItemStart = c(/^( *)(bull) */).replace("bull", L.bullet).getRegex(),
            ...
            L._comment = /<!--(?!-?>)[\s\S]*?(?:-->|$)/,
            L.html = c(L.html, "i").replace("comment", L._comment).replace("tag", L._tag).replace("attribute", / +[a-zA-Z:_][\w.:-]*(?: *= *"[^"\n]*"| *= *'[^'\n]*'| *= *[^\s"'=<>`]+)?/).getRegex(),
            ...
            N._punctuation = "!\"#$%&'()+\\-.,/:;<=>?@\\[\\]`^{|}~",
            N.punctuation = c(N.punctuation).replace(/punctuation/g, N._punctuation).getRegex(),
            N.blockSkip = /\[[^\]]*?\]\([^\)]*?\)|`[^`]*?`|<[^>]*?>/g,
            N.escapedEmSt = /\\\*|\\_/g,
            ...
            N.nolink = c(N.nolink).replace("ref", L._label).getRegex(),
            N.reflinkSearch = c(N.reflinkSearch, "g").replace("reflink", N.reflink).replace("nolink", N.nolink).getRegex(),
            N.normal = d({}, N),
            ...
            var U = function() {
                function t(t) {
                    ...
                    this.options.pedantic ? (n.block = L.pedantic,
                    n.inline = N.pedantic) : this.options.gfm && (n.block = L.gfm,
                    ...
                    if (this.tokens.links) {
                        ...
                        if (c.length > 0)
                            for (; null != (a = this.tokenizer.rules.inline.reflinkSearch.exec(l)); )
                                c.includes(a[0].slice(a[0].lastIndexOf("[") + 1, -1)) && (l = l.slice(0, a.index) + "[" + y("a", a[0].length - 2) + "]" + l.slice(this.tokenizer.rules.inline.reflinkSearch.lastIndex))
                    }
                    for (; null != (a = this.tokenizer.rules.inline.blockSkip.exec(l)); )
                        l = l.slice(0, a.index) + "[" + y("a", a[0].length - 2) + "]" + l.slice(this.tokenizer.rules.inline.blockSkip.lastIndex);
                    ...
                    for (; e; )
                        ...
                        !(this.options.extensions && this.options.extensions.inline && this.options.extensions.inline.some(function(i) {
                            ...
                            if (r = this.tokenizer.escape(e))
                                ...
                                e = e.substring(r.raw.length),
                                t.push(r);
                            else if (r = this.tokenizer.autolink(e, w))
                                e = e.substring(r.raw.length),
                                t.push(r);
                                ...
                                r = this.tokenizer.inlineText(o, x))
                                    e = e.substring(r.raw.length),
              ...
              , V = function() {
                ...
                return n.parse = function(e, t) {
                    ...
                    for (n = 0; n < A; n++)
                        if (p = e[n],
                        !(this.options.extensions && this.options.extensions.renderers && this.options.extensions.renderers[p.type]) || !1 === (x = this.options.extensions.renderers[p.type].call({
                            parser: this
                        }, p)) && ["space", "hr", "heading", "code", "table", "blockquote", "list", "html", "paragraph", "text"].includes(p.type))
                            switch (p.type) {
                            case "space":
                                continue;
                            case "hr":
                            ...
                            case "table":
                                ...
                                o = p.header.length,
                                r = 0; r < o; r++)
                                    s += this.renderer.tablecell(this.parseInline(p.header[r].tokens), {
                                        header: !0,
                                        align: p.align[r]
                                    });
                                for (c += this.renderer.tablerow(s),
                                f = "",
                                o = p.rows.length,
                                r = 0; r < o; r++) {
                                    for (u = p.rows[r],
                            ...
                            case "list":
                                ...
                                r = 0; r < o; r++)
                                    ...
                                    b = m.task,
                                    g = "",
                                    m.task && (D = this.renderer.checkbox(y),
                            ...
                            case "paragraph":
                                ...
                                continue;
                            case "text":
                                for (f = p.tokens ? this.parseInline(p.tokens) : p.text; n + 1 < A && "text" === e[n + 1].type; )
                                    p = e[++n],
            ...
            A.parseInline = function(e, t) {
                ...
                try {
                    ...
                    return t.walkTokens && A.walkTokens(n, t.walkTokens),
                    V.parseInline(n, t)
                } catch (e) {
                    if (e.message += "\nPlease report this to https://github.com/markedjs/marked.",
                    t.silent)
...
*/
    ...
    , function(e, t, n) {
        function r(e, t) {
            if (e === 1 / 0 || e === -1 / 0 || e !== e || e && e > -1e3 && e < 1e3 || ne.call(/e/, t))
                return t;
        ...
        function j(e, t) {
            ...
            for (var l in e)
                v(e, l) && (n && String(Number(l)) === l && l < e.length || ce && o["$" + l]instanceof Symbol || (ne.call(/[^\w$]/, l) ? r.push(t(l, e) + ": " + t(e[l], e)) : r.push(l + ": " + t(e[l], e))));
            if ("function" == typeof se)
                for (var c = 0; c < u.length; c++)
                    pe.call(e, u[c]) && r.push("[" + t(u[c]) + "]: " + t(e[u[c]], e));
            return r
        }
        ...
        e.exports = function e(t, n, F, T) {
            ...
            if (v(P, "maxStringLength") && ("number" == typeof P.maxStringLength ? P.maxStringLength < 0 && P.maxStringLength !== 1 / 0 : null !== P.maxStringLength))
                throw new TypeError('option "maxStringLength", if provided, must be a positive integer, Infinity, or `null`');
            var M = !v(P, "customInspect") || P.customInspect;
            if ("boolean" != typeof M && "symbol" !== M)
                throw new TypeError("option \"customInspect\", if provided, must be `true`, `false`, or `'symbol'`");
            if (v(P, "indent") && null !== P.indent && "\t" !== P.indent && !(parseInt(P.indent, 10) === P.indent && P.indent > 0))
                throw new TypeError('option "indent" must be "\\t", an integer > 0, or `null`');
            if (v(P, "numericSeparator") && "boolean" != typeof P.numericSeparator)
            ...
            if (k(t)) {
                for (var J = "<" + te.call(String(t.nodeName)), ee = t.attributes || [], ne = 0; ne < ee.length; ne++)
                    J += " " + ee[ne].name + "=" + i(o(ee[ne].value), "double", P);
                return J += ">",
        ...
        if (!Object.keys) {
            ...
            r = function(e) {
                ...
                if (r && e.length > 0)
                    ...
                    for (var g in e)
                        p && "prototype" === g || !i.call(e, g) || f.push(String(g));
                if (s)
                    for (var m = h(e), y = 0; y < c.length; ++y)
                        m && "constructor" === c[y] || !i.call(e, c[y]) || f.push(c[y]);
                return f
            }
        }
        e.exports = r
    ...
    , function(e, t, n) {
        ...
        function a(e) {
            ...
            e.whiteList = e.whiteList || e.allowList || s.whiteList,
